...
GMotor motorR(DRIVER2WIRE, MOT_LA, MOT_LB, HIGH);
GMotor motorL(DRIVER2WIRE, MOT_RA, MOT_RB, HIGH);
...
void loop() {
  ...
  if (success) {
    ...
    if (success && millis() - tmr >= 30) {
      ...
      if (ps2x.Button(PSB_R1)) yawP -= MAX_ARM_SPEED;
      if (ps2x.Button(PSB_L1)) yawP += MAX_ARM_SPEED;
      ...
      Serial.print("clawP: ");Serial.print(clawP);Serial.println();
      Serial.print("wristP: ");Serial.print(wristP);Serial.println();
      Serial.print("armP: ");Serial.print(armP);Serial.println();
      Serial.print("yawP: ");Serial.print(yawP);Serial.println();
    ...
    motorR.smoothTick(dutyL);
    motorL.smoothTick(dutyR);
  } else {
